...
export default function ItemMenuToggle({
  ...
  return (
    <div className="group">
      ...
      <div className="overflow-y-auto custom-scrollbar ml-[10px] absolute z-10 top-0 left-[100%] border-l-[8px] border-[#fff] min-h-[500px] w-[calc(65vw)] max-h-[500px] bg-[#fff] hidden group-hover:block">
